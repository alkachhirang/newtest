...
import dailybusiness from '../assets/images/webp/daily-bussiness-img.webp';
import financeimg from '../assets/images/webp/financeimg.webp';
import cnbcimg from '../assets/images/webp/cnbc-img.webp';

const InvestStock = () => {
    return (
        <div className='xl:pt-[126px] lg:pt-[100px] md:pt-[70px] sm:pt-[50px] pt-[40px]'>
            <div className='container lg:max-w-[1164px] px-3'>
                <h2 className='font-bold text-[#101010] text-[27px] sm:text-[36px] md:text-xl capitalize text-center leading-[130%] mb-[30px] md:mb-[50px] xl:mb-[60.5px]' data-aos="fade-down">Why Invest in Nvidia Stock</h2>
                <div className='flex flex-row flex-wrap justify-between mb-[30px] sm:mb-[45px] lg:mb-[60px]'>
                    <div className='lg:w-[33%] md:w-[48%] w-full' data-aos="zoom-in">
                    ...
                    <div className='lg:w-[33%] md:w-[48%] mt-[24px] md:mt-0 w-full' data-aos="zoom-in">
                    ...
                    <div className='lg:w-[33%] w-full mt-[24px] lg:mt-0 max-lg:flex justify-center' data-aos="zoom-in">
                ...
                <div className='flex max-lg:flex-col justify-center items-center gap-[18px] lg:gap-[22px]' data-aos="fade-up">
                    ...
                    <button className="bg-gradient-to-br from-[#034BDA] to-[#33A8FF] shadow-[0_2px_10px_0_rgba(0,_0,_0,_0.15)] btn leading-[150%] capitalize text-nowrap transition-all ease-linear duration-500 py-[11px] px-[29.1px] text-xs font-semibold text-[#FFFFFF] rounded-[58px]  glow-on-hover before:absolute before:top-[-2px] before:left-[-2px] before:z-[-1] before:opacity-0 before:rounded-[50px] after:z-[-1] after:absolute after:w-full after:h-full after:left-0 after:top-0 after:rounded-[50px] hover:before:opacity-[1] relative z-0 outline-none">
                        Invest Now
                    </button>
                </div>
            </div>
