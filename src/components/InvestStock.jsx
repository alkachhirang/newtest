        ...
        <div className='xl:pt-[126px] lg:pt-[100px] md:pt-[70px] sm:pt-[50px] pt-[40px]'>
            <div className='container lg:max-w-[1164px] px-3'>
                ...
                <div className='flex max-lg:flex-col justify-center items-center gap-[18px] lg:gap-[22px]' data-aos="fade-up">
                    ...
                    <button className="bg-gradient-to-br from-[#034BDA] to-[#33A8FF] shadow-[0_2px_10px_0_rgba(0,_0,_0,_0.15)] btn leading-[150%] capitalize text-nowrap transition-all ease-linear duration-500 py-[11px] px-[29.1px] text-xs font-semibold text-[#FFFFFF] rounded-[58px]">
                        Invest Now
                    </button>
                </div>
            </div>
