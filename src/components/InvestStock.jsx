...
import financeimg from '../assets/images/png/finance.png';
    ...
    return (
        <div className='pt-[126px]'>
            <div className='container lg:max-w-[1164px]'>
                <h1 className='font-bold text-[#101010] text-xl capitalize text-center leading-[130%] mb-[60.5px]'>Why Invest in Nvidia Stock</h1>
                <div className='flex flex-row flex-wrap justify-between mb-[60px]'>
