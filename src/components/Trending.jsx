...
const Trending = () => {
    return (
        <div className='xl:pt-[135px] lg:pt-[100px] md:pt-[70px] sm:pt-[50px] pt-[40px]'>
            <div className='xl:max-w-[1360px] bg-gradient-to-br from-[#33A8FF] to-[#034BDA] mx-auto md:shadow-[0_38px_0px_-9px_rgba(232,_241,_253,_1)] py-[40px] sm:py-[50px] md:py-[70px] lg:pt-[79.5px] xl:rounded-[34px] lg:pb-[100px] xl:pb-[132.6px]'>
                <div className='container lg:max-w-[1164px] px-3'>
                    <h2 className='font-bold text-[22px] sm:text-[30px] xl:text-xl text-[#FFFFFF] leading-[130%] text-center flex items-center justify-center gap-[7px] md:gap-[15px] mb-[16px] sm:mb-[35px] md:mb-[50px] xl:mb-[77px]' data-aos="fade-down">Trending about<Nvidia /></h2>
