            ...
            <div className='container lg:max-w-[1164px] px-3'>
                ...
                <div className='flex flex-wrap flex-row justify-between mb-[30px] md:mb-[52px] lg:mb-[82px]'>
                    <div className='lg:w-[49%] w-full relative'>
                        <div className='bg-gradient-to-br from-[#33A8FF] to-[#034BDA] rounded-[24px] md:pt-[47.75px] md:pl-[82.32px] md:pr-[37.48px] p-[16px] sm:p-[25px] lg:max-w-[558px] w-full pb-[30px] lg:pb-0 md:max-h-[274px] md:h-full'>
                    ...
                    <div className='lg:w-[49%] w-full mt-[30px] !sm:mt-[50px]  lg:mt-0'>
                        <div className='bg-gradient-to-br from-[#33A8FF] to-[#034BDA] rounded-[24px] md:pt-[20px] md:pl-[22px] md:pr-[31.2px] p-[16px] sm:p-[25px] lg:max-w-[558px] w-full pb-[20px] lg:pb-0 md:max-h-[274px] md:h-full'>
                            <div className='flex max-sm:flex-col gap-[16.4px] items-center'>
